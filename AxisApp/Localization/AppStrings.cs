...
public static class AppStrings
{
    ...
    private static readonly Dictionary<string, string> En = new()
    {
        ...
        // Join group (redeem someone else's code)
        ["JoinGroup_Title"] = "Join a group",
        ["JoinGroup_CodePlaceholder"] = "Enter invite code",
        ["JoinGroup_PhantomMember"] = "Phantom member",
        ["JoinGroup_Joined"] = "Joined group",

        // Invite to group (share/manage your own group's invite)
        ["InviteToGroup_Title"] = "Invite people",
        ["InviteToGroup_CopyLink"] = "Copy link",
        ["InviteToGroup_UsesLabel"] = "Uses",
        ["InviteToGroup_UsedCount"] = "{0} / {1} used",
        ["InviteToGroup_ExpiresLabel"] = "Expires",
        ["InviteToGroup_Expires1Hour"] = "1 hour",
        ["InviteToGroup_Expires1Day"] = "1 day",
        ["InviteToGroup_Expires7Days"] = "7 days",
        ["InviteToGroup_Expires30Days"] = "30 days",
        ["InviteToGroup_AddMemberByName"] = "Add a member by name",
        ["InviteToGroup_NamePlaceholder"] = "Name (no account needed yet)",
        ["InviteToGroup_AlreadyElsewhere"] = "Already added elsewhere — link instead?",
        ["InviteToGroup_AlreadyOnAxis"] = "Already on Axis — send them the invite code instead",
        ["InviteToGroup_PendingInvites"] = "Pending invites",
        ["InviteToGroup_LinkCopied"] = "Invite link copied",
    ...
    private static readonly Dictionary<string, string> Es = new()
    {
        ...
        // Join group (redeem someone else's code)
        ["JoinGroup_Title"] = "Unirse a un grupo",
        ...
        // Invite to group (share/manage your own group's invite)
        ["InviteToGroup_Title"] = "Invitar personas",
        ["InviteToGroup_CopyLink"] = "Copiar enlace",
        ["InviteToGroup_UsesLabel"] = "Usos",
        ["InviteToGroup_UsedCount"] = "{0} / {1} usados",
        ["InviteToGroup_ExpiresLabel"] = "Caduca",
        ["InviteToGroup_Expires1Hour"] = "1 hora",
        ["InviteToGroup_Expires1Day"] = "1 día",
        ["InviteToGroup_Expires7Days"] = "7 días",
        ["InviteToGroup_Expires30Days"] = "30 días",
        ["InviteToGroup_AddMemberByName"] = "Añadir un miembro por nombre",
        ["InviteToGroup_NamePlaceholder"] = "Nombre (sin cuenta todavía)",
        ["InviteToGroup_AlreadyElsewhere"] = "Ya añadido en otro sitio — ¿vincular en su lugar?",
        ["InviteToGroup_AlreadyOnAxis"] = "Ya tiene cuenta en Axis — envíale el código de invitación",
        ["InviteToGroup_PendingInvites"] = "Invitaciones pendientes",
        ["InviteToGroup_LinkCopied"] = "Enlace de invitación copiado",
