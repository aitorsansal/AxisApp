...
public static class AppStrings
{
    ...
    private static readonly Dictionary<string, string> En = new()
    {
        ...
        ["GroupDetail_StatsTab"] = "Stats",
        ["Stats_SpendByCategory"] = "Spend by category",
        ["Stats_CategoryFrequency"] = "Most used categories",
        ["Stats_SpendByMember"] = "Spend by member",
        ["Stats_PaidMode"] = "Paid",
        ["Stats_ShareMode"] = "Share",
        ["Stats_SettleUpCadence"] = "Settle-ups per month",
        ["Stats_CategoryTrend"] = "Spend by category, over time",
        ["Stats_RangeAllTime"] = "All time",
        ["Stats_Range3Months"] = "3 months",
        ["Stats_Range6Months"] = "6 months",
        ["Stats_Range12Months"] = "12 months",
        ["Stats_Empty"] = "No expenses yet — stats will show up once this group has some history.",
        ["Stats_Export"] = "Export",
        ["Stats_ExportCsv"] = "Export CSV (all expenses)",
        ["Stats_ExportPdf"] = "Export PDF report",
        ["MemberProfile_Empty"] = "No shared groups found for this member.",
        ...
        ["Notification_ActionSettle"] = "Settle",
        ["Notification_ActionView"] = "View",
        ["Notification_ActionGoing"] = "Going",
        ["Notification_ActionMaybe"] = "Maybe",
        ["Notification_ActionNotGoing"] = "Can't go",
        ["Notification_Settled"] = "Settled",
        ["Notification_SettledBody"] = "You're all square.",
        ["Notification_RsvpGoing"] = "You're going",
        ["Notification_RsvpMaybe"] = "Maybe",
        ["Notification_RsvpNotGoing"] = "Can't go",
        ...
        ["Profile_CalendarFeedDescription"] = "Share this link so anyone can subscribe to your events (birthdays excluded) from Google, Apple, or Outlook calendar — read-only, updates automatically, no Axis account needed.",
        ...
        ["Profile_CalendarLinkRegenerated"] = "Link regenerated — the old one no longer works.",
        ["Profile_CalendarShareTitle"] = "Subscribe to my Axis calendar",
        ["Profile_CalendarShareText"] = "Subscribe to my Axis events calendar: {0}",
        ["Profile_RegenerateCalendarLinkTitle"] = "Regenerate calendar link?",
        ["Profile_RegenerateCalendarLinkConfirm"] = "The old link will stop working immediately for anyone who subscribed with it.",
    ...
    private static readonly Dictionary<string, string> Es = new()
    {
        ...
        ["GroupDetail_StatsTab"] = "Estadísticas",

        ["Stats_SpendByCategory"] = "Gasto por categoría",
        ["Stats_CategoryFrequency"] = "Categorías más usadas",
        ["Stats_SpendByMember"] = "Gasto por miembro",
        ["Stats_PaidMode"] = "Pagado",
        ["Stats_ShareMode"] = "Reparto",
        ["Stats_SettleUpCadence"] = "Liquidaciones por mes",
        ["Stats_CategoryTrend"] = "Gasto por categoría, en el tiempo",
        ["Stats_RangeAllTime"] = "Todo",
        ["Stats_Range3Months"] = "3 meses",
        ["Stats_Range6Months"] = "6 meses",
        ["Stats_Range12Months"] = "12 meses",
        ["Stats_Empty"] = "Todavía no hay gastos — las estadísticas aparecerán en cuanto el grupo tenga historial.",
        ["Stats_Export"] = "Exportar",
        ["Stats_ExportCsv"] = "Exportar CSV (todos los gastos)",
        ["Stats_ExportPdf"] = "Exportar informe PDF",
        ["MemberProfile_Empty"] = "No se han encontrado grupos compartidos con este miembro.",
        ...
        ["Notification_ActionSettle"] = "Saldar",
        ["Notification_ActionView"] = "Ver",
        ["Notification_ActionGoing"] = "Voy",
        ["Notification_ActionMaybe"] = "Quizás",
        ["Notification_ActionNotGoing"] = "No voy",
        ["Notification_Settled"] = "Saldado",
        ["Notification_SettledBody"] = "Ya estáis en paz.",
        ["Notification_RsvpGoing"] = "Vas a ir",
        ["Notification_RsvpMaybe"] = "Quizás",
        ["Notification_RsvpNotGoing"] = "No vas a ir",
        ...
        ["Profile_CalendarFeedSection"] = "Calendario",
        ["Profile_CalendarFeedDescription"] = "Comparte este enlace para que cualquiera pueda suscribirse a tus eventos (sin cumpleaños) desde Google, Apple u Outlook — de solo lectura, se actualiza automáticamente, sin necesidad de cuenta de Axis.",
        ...
        ["Profile_CalendarLinkRegenerated"] = "Enlace regenerado — el anterior ya no funciona.",
        ["Profile_CalendarShareTitle"] = "Suscríbete a mi calendario de Axis",
        ["Profile_CalendarShareText"] = "Suscríbete a mi calendario de eventos de Axis: {0}",
        ["Profile_RegenerateCalendarLinkTitle"] = "¿Regenerar el enlace del calendario?",
        ["Profile_RegenerateCalendarLinkConfirm"] = "El enlace anterior dejará de funcionar de inmediato para quien lo tuviera.",
